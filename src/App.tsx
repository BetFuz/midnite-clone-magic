...
const ContestLobby = lazy(() => import("./pages/fantasy/ContestLobby"));
const LiveLeaderboard = lazy(() => import("./pages/fantasy/LiveLeaderboard"));
const ContestHistory = lazy(() => import("./pages/fantasy/ContestHistory"));
